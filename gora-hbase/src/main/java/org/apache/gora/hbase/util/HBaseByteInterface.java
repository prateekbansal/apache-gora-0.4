...
public class HBaseByteInterface {
  ...
  public static final ThreadLocal<BinaryEncoderHolderWithStream> encoderHolders =
      new ThreadLocal<BinaryEncoderHolderWithStream>();
   ...
   */
  public static final class BinaryEncoderHolderWithStream {
      private OutputStream out;
      private BinaryEncoder binaryEncoder;
      
    public BinaryEncoderHolderWithStream(OutputStream out) {
        this.out = out;
        this.binaryEncoder = new EncoderFactory().binaryEncoder(out, null);
    }
  ...
  public static byte[] toBytes(Object o, Schema schema) throws IOException {
    ...
    case RECORD:
      ...
      BinaryEncoderHolderWithStream encoderHolder = encoderHolders.get();

      if (encoderHolder == null) {
          encoderHolder = new BinaryEncoderHolderWithStream(new ByteArrayOutputStream());
          encoderHolders.set(encoderHolder);
      }
      //reset the buffers
      ByteArrayOutputStream os = (ByteArrayOutputStream) encoderHolder.getOut();
      os.reset();
      
      writer.write(o, encoderHolder.getBinaryEncoder());
      encoderHolder.getBinaryEncoder().flush();
